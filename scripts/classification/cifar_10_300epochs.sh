...
RESOURCES="cluster=main tasks_per_node=1 timeout_min=180 use_ddp=False"
WANDB_TAGS='("cifar_sweep","cifar_300epochs",)'
seed=1
...
# Also tried 0.02 but it was too big: diverged
DUAL_LRATES=(0.01 0.007) 

PRIMAL_LRATES=(0.01)
DATA_AUGMENTATION_CHOICES=("True")
